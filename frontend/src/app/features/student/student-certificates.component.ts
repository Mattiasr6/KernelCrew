...
@Component({
  ...
  template: `
    <div class="max-w-[1280px] mx-auto p-6 space-y-8 animate-fade-in">
      ...
      @if (isLoading()) {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          @for (cert of certificates(); track cert.id) {
            ...
            <div class="col-span-full py-20 flex flex-col items-center justify-center glass-card border-dashed bg-transparent">
